...
The Python/OpenCV code for detecting and describing SIFT features on an image, that you can find in the get\{_}homography function in image\{_}alignment.py , is:  
\begin{lstlisting}
...
By checking OpenCV documentation and tutorials online, write the code necessary to visualize detected Sift. The code has to be inserted in the get\{_}homography function in image\{_}alignment.py .
